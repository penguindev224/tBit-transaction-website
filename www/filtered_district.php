		...
		<div class = "main">
			...
			<?php 
				...
				$keyword = $_SERVER['QUERY_STRING'];
							...
							$query = "SELECT RestaurantID, RestaurantName, RestaurantEmail, RestaurantPhone, FoodType, District, RestaurantAddress FROM restaurant WHERE District LIKE '%" . $keyword .  "%'"; 
